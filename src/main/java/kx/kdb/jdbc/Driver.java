...
//javac -Xbootclasspath:/System/Library/Java/JavaVirtualMachines/1.6.0.jdk/Contents/Classes/classes.jar -target 1.6 -source 1.6 Driver.java
public class Driver implements java.sql.Driver {static int V=2,v=0;static void O(String s){System.out.println(s);}
	...
	static{try{DriverManager.registerDriver(new Driver());}catch(Exception e){O(e.getMessage());}}
